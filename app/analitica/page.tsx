...
export default function Analitica() {
  ...
  return (
    <div className="w-full">
            ...
            {([
              ...
              },
              {
                ...
                items: [
                  ...
                  { name: "Plataformas interactivas", image: "/svc/Interactivo.png", paragraph: "Creamos experiencias digitales que cruzan formatos: web, audio, video, narrativa transmedia, interacción.\n\nIntegramos lenguajes del arte, el sonido y el diseño contemplativo para construir plataformas que no solo informan, sino que **emocionan, educan y transforman** a quien las habita." },
                  { name: "Soluciones digitales a la medida", image: "/svc/soluciones.png", paragraph: "Construimos software, sistemas de información y arquitecturas tecnológicas para necesidades específicas que ninguna herramienta del mercado resuelve.\n\nCada solución parte de una **observación cuidadosa** de cómo trabaja tu equipo y aplica metodologías propias de gestión del conocimiento.\n\nPara que la tecnología se adapte a las personas, **no al revés.**" },
                ],
              },
              {
                num: "03",
      ...
      {/* ── Por Qué Divergente ── */}
      <section className="py-28" style={{ background: "#f0ecff", position: "relative", overflow: "hidden", minHeight: isMobile ? "74vh" : "92vh", paddingTop: 0, paddingBottom: 0 }}>
        ...
        <div className="section-wrap" style={{ position: "relative", zIndex: 1, minHeight: "inherit", width: "100%" }}>
          <h2 className="section-heading" style={{ position: "absolute", top: isMobile ? "37%" : "44%", left: "50%", transform: "translate(-50%, -50%)", width: "min(82vw, 46rem)", margin: 0, textAlign: "center" }}>Tecnología y Creatividad con Propósito</h2>
          <div className="body-copy" style={{ position: "absolute", top: isMobile ? "70%" : "79%", left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", gap: "1.25rem", width: "min(82vw, 44rem)", textAlign: "center", color: "#2a1250" }}>
            <p style={{ margin: 0, fontSize: "clamp(1.1rem, 1.3vw, 1.4rem)" }}>Automatizamos lo repetitivo, integramos lo complejo y diseñamos arquitecturas que liberan tiempo, energía y atención para que tu equipo se dedique a lo importante.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "#f0ecff", position: "relative", overflow: "hidden", minHeight: isMobile ? "auto" : "62vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", paddingTop: isMobile ? "2.5rem" : "5rem", paddingBottom: isMobile ? "1rem" : "2em" }}>
        ...
        <a href="https://wa.me/573144869162" target="_blank" rel="noopener noreferrer" aria-label="Trabajemos juntos por WhatsApp"
          ...
          <span className="circle-link" data-brand="whatsapp" aria-hidden="true" style={{ width: "clamp(32px, 2.8vw, 58px)", height: "clamp(32px, 2.8vw, 58px)" }}>
