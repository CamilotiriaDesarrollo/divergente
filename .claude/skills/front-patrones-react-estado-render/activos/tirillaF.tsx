...
export default function TirillaF({
  ...
  return (
    <div
      className={`tirilla-f${dark ? ' tirilla-f--dark' : ''}${staticMode ? ' tirilla-f--static' : ''}`}
    >
      ...
      <div className="tirilla-f__inner">
        ...
        <div className="tirilla-f__fixed-wrap">
          {labelFixed && <span className="tirilla-f__mobile-label">{labelFixed}</span>}
          <div
          ...
          >
            {sistemasFixed.map((s, i) => {
              ...
              return (
                // eslint-disable-next-line jsx-a11y/anchor-is-valid -- TODO: enlazar a cada sistema cuando exista su URL
                <a key={s.id} href="#" className="tirilla-f__item" title={s.descripcion}>
                  ...
                  <span className={`tirilla-f__nombre tirilla-f__nombre${ac}`}>
                    {s.descripcion}
                  </span>
                </a>
              )
        ...
        <div className="tirilla-f__carousel-section">
          {labelCarousel && <span className="tirilla-f__mobile-label">{labelCarousel}</span>}
          <div className="tirilla-f__carousel-wrap">
            <button
              className="tirilla-f__arrow"
            ...
            <div className="tirilla-f__carousel" ref={carouselRef}>
              {carouselItems.map((s, idx) => (
                // eslint-disable-next-line jsx-a11y/anchor-is-valid -- TODO: enlazar a cada plataforma aliada cuando exista su URL
                <a
                  key={`${s.id}-${idx}`}
                  href="#"
                ...
                >
                  ...
                  <span className="tirilla-f__nombre tirilla-f__nombre--carousel">
                    {s.descripcion}
                  </span>
                </a>
              ))}
