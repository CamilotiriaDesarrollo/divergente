...
| 4 | Leads del formulario **salen por WhatsApp** (`wa.me/573144869162`) por ahora. | Definir correo/CRM (decisión 11.6 del roadmap). |
...
| El Método — fondo sutil (opcional) | `/public/mt/observar.jpg` | Foto real de Camilo/taller, tratada en duotono verde, muy tenue. |
| Destacado Conferencias | `/public/mt/camilo-tarima.jpg` | **Foto de Camilo en tarima** (la pieza visual más importante). Tratamiento sobrio. |
...
- [ ] **Fotos de Camilo** en tarima / talleres (ver §4).
